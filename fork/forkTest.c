...
int main()
{
	...
	sprintf(command, "%s", "/cc/vobs/STS/TCU/gugus/bin/writeTestData.tcl");
	...
	if ((pid = fork()) < 0) {
		...
		*/
		...
		/* We're in the child */
		if (execl(command, command, "-S", "A8620DB_S", 
				"-U", "s8610_71_guido", "-P", "MickeyMouse",
				"-D", "/home/roelli/a8610/tests/resuHydra",
				"-T", "resuHydra", NULL) < 0) {
